    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <form class="form-horizontal" id="demo-form" enctype="multipart/form-data" action="{{url('/tokos/store')}}" method="POST" data-parsley-validate>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="nama" class="form-control" placeholder="Nama" required="required" oninvalid="this.setCustomValidity('*Wajib di isi')" oninput="this.setCustomValidity('')">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="offset-sm-2 col-sm-10">
                                    <img width="30%" class="img img-responsive" id='img-upload' />
                                </div>
                            </div>
